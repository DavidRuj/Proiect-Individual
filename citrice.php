      ...
      <div class="row layout_padding2">
        <div class="col-md-8">
          <div class="fruit_detail-box">
            ...
            <p class="mt-4 mb-5">
            Sursă de Energie Naturală: Portocalele sunt bogate în vitamina C și nutrienți esențiali, contribuind la întărirea sistemului imunitar și la menținerea unei stări de sănătate optime.
            </p>
            <div>
        ...
        <div class="row layout_padding2-top layout_padding-bottom">
          <div class="col-md-8">
            <div class="fruit_detail-box">
              ...
              <p class="mt-4 mb-5">
              Descoperiți plăcerea autentică a lămâilor proaspete, oferindu-vă o explozie răcoritoare de gust și vitalitate. Fiecare lămâie pe care o oferim este aleasă cu atenție din livezi cultivate cu pasiune și respect pentru calitate, pentru a vă aduce o experiență citrică de neuitat.
              </p>
              <div>
                <a href="" class="custom_dark-btn">
                  Cumpără
        ...
        <div class="col-md-4 d-flex justify-content-center align-items-center">
          <div class="fruit_img-box d-flex justify-content-center align-items-center">
            <img src="images/lemons.png" alt="" class="" width="225px" />
          </div>
        </div>
        </div>
